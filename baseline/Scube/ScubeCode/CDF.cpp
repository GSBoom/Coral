...
int main(){
  ...
  */ 
    for(int num:v){
        ...
        string result_path=queryinfo+data_set_name0+"cdf"+"edge_weight_info.txt";
        cout<<"result file path "<<result_path<<endl;
        edgeFrequenceQueryTest(*scube,qdarray,querynum,1,result_path,1); 
        cout <<"****************** Scube edge Weight Query end *****************" << endl;
        cout<<endl;

        cout <<"****************** Scube inflow-Nodequery start *****************" << endl;
        string result_path1=queryinfo+data_set_name0+"cdf"+"inflow_weight_info.txt";
        nodeFrequenceQueryTest(*scube,qdarray,querynum,1,result_path1,1,1);
        cout <<"****************** Scube inflow-Nodequery end *****************" << endl;
        cout<<endl;
/*
        cout <<"****************** Scube outflow-Nodequery start *****************" << endl;
        string result_path2=queryinfo+data_set_name0+"cdf"+"outflow_weight_info.txt";
        nodeFrequenceQueryTest(*scube,qdarray,querynum,1,result_path2,0,1);
        cout <<"****************** Scube outflow-Nodequery end *****************" << endl;
        cout<<endl;
*/
        cout <<"****************** Scube reachability query start *****************" << endl;
        string result_path3=queryinfo+data_set_name0+"cdf"+"reachability_info.txt";
        reachabilityQueryTest(*scube,qdarray,querynum,1,result_path3,1);
